...
fl GetA(const qt& q) { return q.R_component_1(); }
fl GetB(const qt& q) { return q.R_component_2(); }
fl GetC(const qt& q) { return q.R_component_3(); }
fl GetD(const qt& q) { return q.R_component_4(); }
