...
struct ligand : public flexible_body, atom_range {
  unsigned degrees_of_freedom;  // can be different from the apparent number of
                                // rotatable bonds, because of the disabled
                                // torsions
...
struct model {
  ...
  bool atom_exists_between(const distance_type_matrix& mobility,
                           ...
                           const szv& relevant_atoms) const;  // there is an
                                                              // atom closer to
                                                              // both a and b
                                                              // then they are
                                                              // to each other
 ...
 private:
  ...
  void assign_bonds(const distance_type_matrix& mobility);  // assign bonds
                                                            // based on relative
                                                            // mobility,
                                                            // distance and
                                                            // covalent length
  ...
  interacting_pairs other_pairs;  // all except internal to one ligand:
                                  // ligand-other ligands; ligand-flex/inflex;
                                  // flex-flex/inflex
